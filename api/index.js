...
app.post('/api/email/send', async (req, res) => {
  try {
    ...
    await transporter.sendMail({
      ...
      text: `Thanks for stopping by!\n\nHere's your photo strip from DEC Photobooth. We hope you had a great time.\n\nHope to see you again soon!\n\n- DEC Photobooth`,
      html: `<!DOCTYPE html><html><head><meta charset="utf-8"></head><body style="margin:0;padding:0;background:#111;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#111"><tr><td align="center" style="padding:40px 20px"><table role="presentation" width="480" cellspacing="0" cellpadding="0" border="0" style="max-width:480px;width:100%"><tr><td align="center" style="padding-bottom:16px"><h1 style="margin:0;font-size:22px;font-weight:700;color:#fff">Thanks for stopping by!</h1></td></tr><tr><td align="center" style="padding-bottom:24px"><p style="margin:0;font-size:14px;color:#888;line-height:1.6">Here's your photo strip from DEC Photobooth.<br/>We hope you had a great time.</p></td></tr><tr><td align="center" style="padding-bottom:24px"><img src="cid:photostrip" alt="Photo strip" style="display:block;max-width:100%;height:auto;border-radius:12px;border:1px solid rgba(255,255,255,0.08)" /></td></tr><tr><td align="center"><p style="margin:0;font-size:13px;color:#666">Hope to see you again soon!</p><p style="margin:8px 0 0;font-size:12px;color:#555">— DEC Photobooth</p></td></tr></table></td></tr></table></body></html>`,
      attachments,
    })
